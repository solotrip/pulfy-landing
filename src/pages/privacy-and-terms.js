...
export default function Terms () {
  return (
    <div className={styles.outer}>
      ...
      <div className={styles.wrapper}>
        <div className={styles.row2}>
          ...
          <div className={styles.row1Subtitle5}>
            <div>
              {' '}
              At Pulfy, accessible from pulfy.com, one of our main priorities is
              the privacy of our visitors. This Privacy Policy document contains
              types of information that is collected and recorded by Pulfy and
              how we use it.
            </div>
            ...
            <div>
              ...
              that they shared and/or collect in Pulfy. This policy is not
            ...
            <div>
              Pulfy follows a standard procedure of using log files. These files
              ...
              <div>
                Like any other website, Pulfy uses 'cookies'. These cookies are
              ...
              <div>
                ...
                the advertising partners of Pulfy.
              </div>
              <div>
                Third-party ad servers or ad networks uses technologies like
                cookies, JavaScript, or Web Beacons that are used in their
                respective advertisements and links that appear on Pulfy, which
              ...
              <div>
                Note that Pulfy has no access to or control over these cookies
              ...
              <div>
                Pulfy's Privacy Policy does not apply to other advertisers or
              ...
              <div>
                Pulfy does not knowingly collect any Personal Identifiable
      ...
      <div className={styles.wrapper}>
        <div className={styles.row2}>
          <div className={styles.featureTitle5}>
          ...
          <div className={styles.row1Subtitle5}>
            ...
            <p>
              By accessing this Website, accessible from https://www.pulfy.com,
            ...
            <p>
              ...
              materials on Pulfy's Website for personal, non-commercial
            ...
            <ul>
              ...
              <li>
                attempt to reverse engineer any software contained on Pulfy's
                Website;
              </li>
              <li>
            ...
            <p>
              This will let Pulfy to terminate upon violations of any of these
            ...
            <p>
              All the materials on Pulfy’s Website are provided "as is". Pulfy
              makes no warranties, may it be expressed or implied, therefore
              negates all other warranties. Furthermore, Pulfy does not make any
            ...
            <p>
              Pulfy or its suppliers will not be hold accountable for any
              damages that will arise with the use or inability to use the
              materials on Pulfy’s Website, even if Pulfy or an authorize
            ...
            <p>
              The materials appearing on Pulfy’s Website may include technical,
              typographical, or photographic errors. Pulfy will not promise that
              any of the materials in this Website are accurate, complete, or
              current. Pulfy may change the materials contained on its Website
              at any time without notice. Pulfy does not make any commitment to
            ...
            <p>
              Pulfy has not reviewed all of the sites linked to its Website and
              is not responsible for the contents of any such linked site. The
              presence of any link does not imply endorsement by Pulfy of the
            ...
            <p>
              Pulfy may revise these Terms of Use for its Website at any time
            ...
            <p>
              Any claim related to Pulfy's Website shall be governed by the laws
